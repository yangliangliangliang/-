...
<script>
	...
	//方法
	import { stripscript,verifyPhone} from "@/utils/index.js"
	export default {
		data() {
			return {
				//logo图片 base64
		...
		methods: {
			//登录密码离开时
			pwBlur(){
				this.password = stripscript(this.password)
			},
			//是否选择协议
			isShowAgree(){
			...
			getVerCode(){
				...
				this.$minApi.getCode({
					...
					this.verCode = uni.getStorageSync('verCode');
					console.log(res)
